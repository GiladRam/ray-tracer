...
void scene1(const Camera* camera) {
  ...
  scene.add(new Plane(
    Vector(0, 0, 0),
    Vector(0, 1, 0),
    Material(Color::YELLOW, 1, .8, 0, 0, 0, 0)
  ));
  // back wall
  scene.add(new Plane(
    Vector(0, 0, -30),
    Vector(0, 0, 1),
    Material(Color::BLUE, 1, .8, 0, 0, 0, 0)
  ));
  // red ball
  scene.add(new Sphere(
    Vector(5, 5, -15), 2,
    Material(Color::RED, .5, .8, .2, 0, 0, 0)
  ));
  // white ball
  scene.add(new Sphere(
    Vector(-5, 5, -15), 3,
    Material(Color::WHITE, .5, .8, .2, 0, 0, 0)
  ));
...
void scene3(const Camera* camera) {
  ...
  scene.add(new Plane(
    Vector(0, 0, 0),
    Vector(0, 1, 0),
    Material(Color::WHITE, 1, .8, .5, 0, 0, 0)
  ));
  // back wall
  scene.add(new Plane(
    Vector(0, 0, -30),
    Vector(0, 0, 1),
    Material(Color::RED, 1, .8, .5, 0, 0, 0)
  ));
//  // red ball
//  scene.add(new Sphere(
//    Vector(5, 5, -15), 2,
...
//  scene.add(new Sphere(
//    Vector(-5, 5, -15), 3,
//    Material(Color::YELLOW, .5, .8, .2, 0, 0, 0)
//  ));
  scene.render();
